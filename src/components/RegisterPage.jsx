            ...
            >
                <div className="text-center mb-8">
                    ...
                    <h1 className="font-display text-3xl font-black mb-2" style={{ color: 'var(--text-primary)' }}>
                        Join AICROP-DETECTOR
                    </h1>
                    <p className="text-sm font-body opacity-60" style={{ color: 'var(--text-primary)' }}>
                        Create your free account and start farming smarter
                    </p>
                </div>

                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        <label className="block text-xs font-mono font-medium mb-2 opacity-60" style={{ color: 'var(--text-primary)' }}>Full Name</label>
                        <input
                            type="text"
                    ...
                    <div>
                        <label className="block text-xs font-mono font-medium mb-2 opacity-60" style={{ color: 'var(--text-primary)' }}>Confirm Password</label>
                        <input
                            type="password"
                            placeholder="••••••••"
                ...
                <div className="mt-6 text-center">
                    <p className="text-sm font-body opacity-50" style={{ color: 'var(--text-primary)' }}>
                        ...
                        <Link to="/login" className="font-bold hover:underline" style={{ color: 'var(--neon-primary)' }}>
                            Login
                        </Link>
                    </p>
                </div>
